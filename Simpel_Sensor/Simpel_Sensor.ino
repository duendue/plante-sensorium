...
void CSread() {
  long cs0 = cs_2_3.capacitiveSensor(80); //a: Sensor resolution is set to 80
  long cs1 = cs_4_5.capacitiveSensor(80); //a: Sensor resolution is set to 80
  //long cs2 = cs_6_7.capacitiveSensor(80); //a: Sensor resolution is set to 80
 /* long cs3 = cs_8_9.capacitiveSensor(80); //a: Sensor resolution is set to 80
  long cs4 = cs_10_11.capacitiveSensor(80); //a: Sensor resolution is set to 80
  long cs5 = cs_12_13.capacitiveSensor(80); //a: Sensor resolution is set to 80
*/
    if(cs0 > 0){
